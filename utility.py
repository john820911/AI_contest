...
def prepare_custom_data(dict_directory, train_enc, train_dec, test_enc, test_dec, enc_vocabulary_size, dec_vocabulary_size, tokenizer=None):
    enc_vocab_path = os.path.join(dict_directory, "vocab%d.enc" % enc_vocabulary_size)
    dec_vocab_path = os.path.join(dict_directory, "vocab%d.dec" % dec_vocabulary_size)
    ...
    enc_train_ids_path = train_enc.split(".")[0] + ("%d.enc" % enc_vocabulary_size)
    dec_train_ids_path = train_dec.split(".")[0] + ("%d.dec" % dec_vocabulary_size)
    ...
    enc_dev_ids_path = test_enc.split(".")[0] + "%d.enc" % enc_vocabulary_size
    dec_dev_ids_path = test_dec.split(".")[0] + "%d.dec" % dec_vocabulary_size
